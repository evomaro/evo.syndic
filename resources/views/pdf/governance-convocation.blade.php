...
</style></head><body><header><div class="brand">EVOSYNDIC · CONVOCATION OFFICIELLE</div><h1>Assemblée générale / <span class="ar">الجمع العام</span></h1><div>{{ $payload['residence']['name'] }} · {{ $payload['assembly']['reference'] }}</div></header>
...
<div class="footer">Source configurée: {{ $payload['legal']['official_source'] }} · Articles {{ implode(', ', $payload['legal']['articles']) }} · Statut de revue: {{ $payload['legal']['review_status'] }}<br>SHA-256 calculé sur le PDF émis et conservé dans le registre EvoSyndic.</div></body></html>
