...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('residence_announcements', function (Blueprint $table) {
            ...
            $table->dateTime('last_publication_attempt_at')->nullable()->after('publication_attempts');
            $table->dateTime('publication_failed_at')->nullable()->after('last_publication_attempt_at');
            ...
            $table->dateTime('publication_failure_resolved_at')->nullable()->after('publication_failure_summary');
        });

        Schema::table('residence_documents', function (Blueprint $table) {
            $table->dateTime('scheduled_for')->nullable()->after('expires_at');
            $table->unsignedSmallInteger('publication_attempts')->default(0)->after('scheduled_for');
            $table->dateTime('last_publication_attempt_at')->nullable()->after('publication_attempts');
            $table->dateTime('publication_failed_at')->nullable()->after('last_publication_attempt_at');
            $table->string('publication_failure_code', 80)->nullable()->after('publication_failed_at');
